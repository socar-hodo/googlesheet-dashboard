...
SELECT
  ...
  p.usage_count,
  p.opr_day,
  SAFE_DIVIDE(p.revenue, p.opr_day) AS revenue_per_car,
  SAFE_DIVIDE(p.usage_count, p.opr_day) AS usage_count_per_car,
  SAFE_DIVIDE(p.usage_hours, p.opr_day) AS usage_hours_per_car,
